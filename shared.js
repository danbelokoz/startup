...
const T = {
  ...
  zh: {
    ...
    startupPage: { back:'返回目录', founded:'成立于', country:'国家', audience:'目标受众', provider:'支付提供商', customers:'客户', subs:'活跃订阅', rev30:'收入（30天）', mrr:'MRR', totalRev:'总收入', growth:'30天增长', margin:'利润率', rank:'排名', visitors:'访客（30天）', contact:'联系卖家', viewOriginal:'访问网站', forSale:'在售', notForSale:'不出售', price:'要价', multiple:'收入倍数', techStack:'技术栈', cofounders:'联合创始人', reveal:'打开卖家联系方式和网站', revealBtn:'打开', revealNote:'消耗您每日限额中的1次查看', dailyChart:'每日指标', chartCollecting:'正在收集每日数据', chartWillAppear:'图表将在几天后显示 — 我们每天 3:00 UTC 保存一次快照。', chartEstimated:'估算', chartStaleNote:'最近 {n} 天无数据', tipProvider:'收入直接通过该支付提供商验证', tipMor:'Merchant of Record — 提供商负责账单、税务与合规', tipRank:'在所有已验证初创公司收入总排名中的位置', tipStealth:'创始人隐藏了公司名称', tipCofounder:'创始人正在寻找联合创始人', tipFunding:'初创公司的融资状态', tipScore:'收购吸引力评分（0-100），越高越好', archivedTitle:'此列表已停止更新', archivedNote:'该初创公司已不在我们的数据来源中发布 — 已下架或被移除。下方为我们最后保存的数据，截至 {date}。', archivedNoteNoDate:'该初创公司已不在我们的数据来源中发布 — 已下架或被移除。下方为我们最后保存的数据。' },
