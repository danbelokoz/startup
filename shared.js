...
const T = {
  ...
  de: {
    ...
    startupPage: { back:'Zurück zum Katalog', founded:'Gegründet', country:'Land', audience:'Zielgruppe', provider:'Zahlungsanbieter', customers:'Kunden', subs:'Aktive Abonnements', rev30:'Umsatz (30 Tage)', mrr:'MRR', totalRev:'Gesamtumsatz', growth:'30-Tage Wachstum', margin:'Gewinnmarge', rank:'Rang', visitors:'Besucher (30T)', contact:'Verkäufer kontaktieren', viewOriginal:'Website öffnen', forSale:'Zum Verkauf', notForSale:'Nicht zum Verkauf', price:'Verkaufspreis', multiple:'Umsatzmultiplikator', techStack:'Tech Stack', cofounders:'Mitgründer', reveal:'Verkäuferkontakte und Website öffnen', revealNote:'verbraucht 1 Aufruf aus deinem Tageslimit', dailyChart:'Tägliche Metriken', chartCollecting:'Sammle tägliche Daten', chartWillAppear:'Diagramm erscheint in einigen Tagen — wir speichern täglich um 3:00 UTC einen Snapshot.' },
