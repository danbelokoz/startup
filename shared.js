...
const T = {
  en: {
    ...
    nav: { home:'Home', catalog:'Catalog', acquire:'Buy', sell:'Sell a startup', apiKey:'API key', top:'Top growing', vote:'Vote' },
  ...
  de: {
    ...
    nav: { home:'Startseite', catalog:'Katalog', acquire:'Kaufen', sell:'Startup verkaufen', apiKey:'API-Schlüssel', top:'Top-Wachstum', vote:'Abstimmen' },
  ...
  fr: {
    ...
    nav: { home:'Accueil', catalog:'Catalogue', acquire:'Acheter', sell:'Vendre une startup', apiKey:'Clé API', top:'En croissance', vote:'Voter' },
    ...
    startupPage: { back:'Retour au catalogue', founded:'Fondée', country:'Pays', audience:'Audience', provider:'Fournisseur de paiement', customers:'Clients', subs:'Abonnements actifs', rev30:'Revenu (30 jours)', mrr:'MRR', totalRev:'Revenu total', gmv:'GMV', gmv30:'GMV (30 jours)', tipGmv:'Volume brut des ventes traité par cette boutique, et non le revenu récurrent propre de la société', growth:'Croissance 30 jours', margin:'Marge bénéficiaire', rank:'Rang', visitors:'Visiteurs (30j)', contact:'Contacter le vendeur', viewOriginal:'Visiter le site', forSale:'À vendre', notForSale:'Non à vendre', price:'Prix demandé', multiple:'Multiple de revenus', techStack:'Stack technique', cofounders:'Cofondateurs', reveal:'Ouvrir les contacts du vendeur et le site', revealBtn:'Ouvrir', revealNote:'consomme 1 vue de votre limite quotidienne', regGate:'Inscrivez-vous gratuitement — débloquez tout le site', regNote:'Données complètes de la startup, lien du site et contacts du fondateur.\nJuste un email et un mot de passe.', regBtn:'S’inscrire', descMore:'Inscrivez-vous pour lire la description complète', dailyChart:'Métriques quotidiennes', chartCollecting:'Collecte des données quotidiennes', chartWillAppear:'Le graphique apparaîtra dans quelques jours - nous capturons les métriques chaque jour à 3h00 UTC.', chartEstimated:'Estimé', chartStaleNote:'Aucune donnée sur les {n} derniers jours', chartNoDaily:'Les données quotidiennes ne sont pas transmises', chartNoDailySince:'Les données quotidiennes ne sont pas transmises depuis le {date}', chartNoDailyNote:'Notre source ne fournit pas de détail jour par jour pour cette startup.', tipProvider:'Revenu vérifié directement via ce fournisseur de paiement', tipMor:'Merchant of Record - le fournisseur gère la facturation, les taxes et la conformité', tipRank:'Position dans le classement général par revenu parmi toutes les startups vérifiées', tipStealth:'Le fondateur garde le nom de la startup caché', tipCofounder:'Le fondateur cherche un cofondateur', tipFunding:'Statut de financement de la startup', tipScore:"Score d'attractivité pour l'achat de 0 à 100 - plus haut, c'est mieux", archivedTitle:'Cette annonce n’est plus mise à jour', archivedNote:'Cette startup n’est plus publiée dans notre source de données - elle a été retirée ou supprimée. Les chiffres ci-dessous sont les derniers que nous avons enregistrés, au {date}.', archivedNoteNoDate:'Cette startup n’est plus publiée dans notre source de données - elle a été retirée ou supprimée. Les chiffres ci-dessous sont les derniers que nous avons enregistrés.' },
    idx: { heroTitle:'Trouvez une', heroSpan:'startup vérifiée', heroEnd:'avec revenus confirmés', heroSub:'Uniquement des données vérifiées. Chaque métrique vérifiée directement via les fournisseurs de paiement.', statTotal:'Startups dans la base', statSale:'À vendre', statRev30:'Revenu (30j)', statMrr:'MRR total', fltTitle:'Filtres', fltReset:'Réinitialiser', fltSearch:'Rechercher par nom...', fltStatus:'Statut', fltStatusSale:'À vendre', fltStatusAll:'Tous', fltCats:'Catégories', fltCatsAll:'Toutes les catégories...', fltRev30:'Revenu 30 jours', fltMrr:'MRR', fltGrowth:'Croissance 30 jours', fltPrice:'Prix demandé', fltMultiple:'Multiple', fltMargin:'Marge bénéficiaire', fltAudience:'Audience', fltMobile:'Application mobile', fltAdded:'Ajoutées', fltAddedAny:'Tout le temps', fltAdded1d:'Dernières 24 heures', fltAdded7d:'7 derniers jours', fltAdded14d:'14 derniers jours', fltAdded30d:'30 derniers jours', tipAdded:'Date d\'ajout du produit sur la place de marché', fltApply:'Appliquer les filtres', fltShow:'Afficher', fltGrpFin:'Revenu et MRR', fltGrpDeal:'Croissance et prix', fltGrpMore:'Plus de filtres', fltAny:'Tout', fltHas:'Oui', fltNo:'Non', sortRev:'Revenu ↓', sortGrowth:'Croissance ↓', sortPriceAsc:'Prix ↑', sortPriceDesc:'Prix ↓', sortAdded:'Plus récents', sortAddedOld:'Plus anciens', loading:'Chargement des startups...', error:'Erreur de chargement', notFound:'Rien trouvé', countStartups:'startups', countOnSale:'à vendre', tipRev30:'Revenu total des 30 derniers jours', tipGmv:'Volume brut traité via la plateforme - pas le revenu de la société', tipMrr:'Monthly Recurring Revenue', tipGrowth:'Variation MRR sur 30 jours en %', tipPrice:'Prix demandé pour 100% du capital', tipMultiple:'Prix / MRR annuel', cardRev:'Rev. 30j', cardAsk:'Prix', cardMult:'Multiple', cardMrr:'MRR', favorites:'Favoris', anonLabel:'anonyme', anonHint:'Le fondateur reste anonyme', anonNoDesc:'Le vendeur préfère ne pas divulguer les détails du produit.', acqHeroTitle:'Achète une', acqHeroSpan:'startup rentable', acqHeroEnd:'avec métriques confirmées', acqHeroSub:'Chaque annonce a un MRR réel vérifié via les fournisseurs de paiement - pas d\'estimations.', statAvgMult:'Multiple moyen' },
  ...
  it: {
    ...
    nav: { home:'Home', catalog:'Catalogo', acquire:'Acquista', sell:'Vendi startup', apiKey:'Chiave API', top:'In crescita', vote:'Vota' },
  ...
  ru: {
    ...
    nav: { home:'Главная', catalog:'Каталог', acquire:'Купить', sell:'Продать стартап', apiKey:'API ключ', top:'Топ растущих', vote:'Голосование' },
  ...
  zh: {
    ...
    nav: { home:'首页', catalog:'目录', acquire:'购买', sell:'出售初创公司', apiKey:'API 密钥', top:'增长榜', vote:'投票' },
    ...
    startupPage: { back:'返回目录', founded:'成立于', country:'国家', audience:'目标受众', provider:'支付提供商', customers:'客户', subs:'活跃订阅', rev30:'收入（30天）', mrr:'MRR', totalRev:'总收入', gmv:'GMV', gmv30:'GMV（30天）', tipGmv:'通过该店铺处理的销售总额（GMV），而非公司自身的经常性收入', growth:'30天增长', margin:'利润率', rank:'排名', visitors:'访客（30天）', contact:'联系卖家', viewOriginal:'访问网站', forSale:'在售', notForSale:'不出售', price:'要价', multiple:'收入倍数', techStack:'技术栈', cofounders:'联合创始人', reveal:'打开卖家联系方式和网站', revealBtn:'打开', revealNote:'消耗您每日限额中的1次查看', regGate:'免费注册 — 解锁全站功能', regNote:'完整的初创公司数据、网站链接和创始人联系方式。\n只需邮箱和密码。', regBtn:'注册', descMore:'注册以阅读完整介绍', dailyChart:'每日指标', chartCollecting:'正在收集每日数据', chartWillAppear:'图表将在几天后显示 - 我们每天 3:00 UTC 保存一次快照。', chartEstimated:'估算', chartStaleNote:'最近 {n} 天无数据', chartNoDaily:'未提供每日数据', chartNoDailySince:'自 {date} 起未提供每日数据', chartNoDailyNote:'我们的数据来源未提供该初创公司的每日明细。', tipProvider:'收入直接通过该支付提供商验证', tipMor:'Merchant of Record - 提供商负责账单、税务与合规', tipRank:'在所有已验证初创公司收入总排名中的位置', tipStealth:'创始人隐藏了公司名称', tipCofounder:'创始人正在寻找联合创始人', tipFunding:'初创公司的融资状态', tipScore:'收购吸引力评分（0-100），越高越好', archivedTitle:'此列表已停止更新', archivedNote:'该初创公司已不在我们的数据来源中发布 - 已下架或被移除。下方为我们最后保存的数据，截至 {date}。', archivedNoteNoDate:'该初创公司已不在我们的数据来源中发布 - 已下架或被移除。下方为我们最后保存的数据。' },
    idx: { heroTitle:'寻找', heroSpan:'经过验证的初创公司', heroEnd:'收入已确认', heroSub:'仅限验证数据。每项指标都通过支付提供商直接验证。', statTotal:'数据库中的初创公司', statSale:'在售', statRev30:'收入（30天）', statMrr:'总 MRR', fltTitle:'筛选器', fltReset:'重置', fltSearch:'按名称搜索...', fltStatus:'状态', fltStatusSale:'在售', fltStatusAll:'全部', fltCats:'类别', fltCatsAll:'所有类别...', fltRev30:'30天收入', fltMrr:'MRR', fltGrowth:'30天增长', fltPrice:'要价', fltMultiple:'倍数', fltMargin:'利润率', fltAudience:'目标受众', fltMobile:'移动应用', fltAdded:'添加时间', fltAddedAny:'全部时间', fltAdded1d:'最近24小时', fltAdded7d:'最近7天', fltAdded14d:'最近14天', fltAdded30d:'最近30天', tipAdded:'产品加入市场的日期', fltApply:'应用筛选', fltShow:'显示', fltGrpFin:'收入与 MRR', fltGrpDeal:'增长与价格', fltGrpMore:'更多筛选', fltAny:'任何', fltHas:'有', fltNo:'无', sortRev:'收入 ↓', sortGrowth:'增长 ↓', sortPriceAsc:'价格 ↑', sortPriceDesc:'价格 ↓', sortAdded:'最新优先', sortAddedOld:'最早优先', loading:'加载初创公司...', error:'加载数据时出错', notFound:'未找到任何内容', countStartups:'初创公司', countOnSale:'在售', tipRev30:'过去30天的总收入', tipGmv:'通过平台处理的总交易额 - 而非公司自身收入', tipMrr:'Monthly Recurring Revenue', tipGrowth:'30天MRR变化百分比', tipPrice:'100%股权的要价', tipMultiple:'价格 / 年化MRR', cardRev:'30天收入', cardAsk:'要价', cardMult:'倍数', cardMrr:'MRR', favorites:'收藏', anonLabel:'匿名', anonHint:'创始人选择匿名', anonNoDesc:'卖家选择不披露产品细节。', acqHeroTitle:'购买', acqHeroSpan:'盈利的初创公司', acqHeroEnd:'指标已验证', acqHeroSub:'每个列表都有通过支付提供商验证的真实 MRR - 无估算。', statAvgMult:'平均倍数' },
  ...
  ar: {
    ...
    nav: { home:'الرئيسية', catalog:'الكتالوج', acquire:'شراء', sell:'بيع شركة ناشئة', apiKey:'مفتاح API', top:'الأسرع نموًا', vote:'تصويت' },
...
Object.assign(T.en, { gate: { title:'Create a free account to see everything', sub:'Revenue, MRR, seller website and founder — no subscription, no card.', perk1:'Verified MRR and revenue', perk2:'Seller site and founder', perk3:'Favorites and comparison', haveAcc:'Already have an account?', noAcc:'No account yet?', freeNote:'Free · no card required', gotIt:'Got it', errFields:'Enter your email and a password.', locked:'This startup is available to registered users', lockedCta:'Register free' } });
Object.assign(T.ru, { gate: { title:'Создайте бесплатный аккаунт, чтобы увидеть всё', sub:'Выручка, MRR, сайт продавца и основатель — без подписки и без карты.', perk1:'Проверенные MRR и выручка', perk2:'Сайт продавца и основатель', perk3:'Избранное и сравнение', haveAcc:'Уже есть аккаунт?', noAcc:'Ещё нет аккаунта?', freeNote:'Бесплатно · без карты', gotIt:'Понятно', errFields:'Введите email и пароль.', locked:'Этот стартап доступен зарегистрированным пользователям', lockedCta:'Зарегистрироваться бесплатно' } });
Object.assign(T.de, { gate: { title:'Erstelle ein kostenloses Konto, um alles zu sehen', sub:'Umsatz, MRR, Verkäufer-Website und Gründer — ohne Abo, ohne Karte.', perk1:'Verifizierte MRR und Umsätze', perk2:'Verkäufer-Website und Gründer', perk3:'Favoriten und Vergleich', haveAcc:'Schon ein Konto?', noAcc:'Noch kein Konto?', freeNote:'Kostenlos · ohne Karte', gotIt:'Verstanden', errFields:'Gib E-Mail und Passwort ein.', locked:'Dieses Startup ist registrierten Nutzern vorbehalten', lockedCta:'Kostenlos registrieren' } });
Object.assign(T.fr, { gate: { title:'Créez un compte gratuit pour tout voir', sub:'Revenus, MRR, site du vendeur et fondateur — sans abonnement ni carte.', perk1:'MRR et revenus vérifiés', perk2:'Site du vendeur et fondateur', perk3:'Favoris et comparaison', haveAcc:'Vous avez déjà un compte ?', noAcc:'Pas encore de compte ?', freeNote:'Gratuit · sans carte', gotIt:'Compris', errFields:'Saisissez votre e-mail et un mot de passe.', locked:'Cette startup est réservée aux utilisateurs inscrits', lockedCta:'S’inscrire gratuitement' } });
Object.assign(T.it, { gate: { title:'Crea un account gratuito per vedere tutto', sub:'Ricavi, MRR, sito del venditore e fondatore — senza abbonamento e senza carta.', perk1:'MRR e ricavi verificati', perk2:'Sito del venditore e fondatore', perk3:'Preferiti e confronto', haveAcc:'Hai già un account?', noAcc:'Non hai ancora un account?', freeNote:'Gratis · senza carta', gotIt:'Ho capito', errFields:'Inserisci email e password.', locked:'Questa startup è riservata agli utenti registrati', lockedCta:'Registrati gratis' } });
Object.assign(T.zh, { gate: { title:'免费注册账户，查看全部信息', sub:'收入、MRR、卖家网站和创始人 — 无需订阅，无需银行卡。', perk1:'已验证的 MRR 与收入', perk2:'卖家网站与创始人', perk3:'收藏与对比', haveAcc:'已有账户？', noAcc:'还没有账户？', freeNote:'免费 · 无需银行卡', gotIt:'知道了', errFields:'请输入邮箱和密码。', locked:'该初创公司仅向注册用户开放', lockedCta:'免费注册' } });
Object.assign(T.ar, { gate: { title:'أنشئ حسابًا مجانيًا لرؤية كل التفاصيل', sub:'الإيرادات وMRR وموقع البائع والمؤسّس — بدون اشتراك وبدون بطاقة.', perk1:'MRR وإيرادات موثّقة', perk2:'موقع البائع والمؤسّس', perk3:'المفضلة والمقارنة', haveAcc:'لديك حساب بالفعل؟', noAcc:'ليس لديك حساب بعد؟', freeNote:'مجاني · بدون بطاقة', gotIt:'حسنًا', errFields:'أدخل بريدك الإلكتروني وكلمة المرور.', locked:'هذه الشركة الناشئة متاحة للمستخدمين المسجّلين', lockedCta:'سجّل مجانًا' } });
...
// Startup detail page - metrics block + daily chart (added 2026-06-26 redesign).
Object.assign(T.en.startupPage, { revenueMetrics:'Revenue metrics', insights:'Startup insights', info:'Info', allTime:'all time', estUsers:'Est. users', revPerVisitor:'Revenue / visitor', googleImpr:'Google impressions (30d)', xFollowers:'𝕏 followers', verified:'Verified', mrrVsPrev:'vs prev. 30d', flat:'flat', cmDailyRev:'Daily revenue', cmMrr:'MRR', cmCustomers:'Customers', cmSubs:'Subscriptions', cmGrowth:'Growth %', cmVisitors:'Visitors', cmPrice:'Asking price', perDaySuffix:'d', perAll:'All', legCurrent:'Current period', legPrevious:'Previous period', legNow:'Now', legMax:'Max', legMin:'Min', legPoints:'{n} points', vsPrevPeriod:'vs prev. period', vsPrevNDays:'vs prev. {n}d', ttAvgPayment:'Avg. payment: {v}', ttPayments:'{n} payments', reset:'Reset', rankBasis:'by revenue', ttPrev:'Prev.', tipVerified:'Revenue and MRR are confirmed directly from the payment provider — the seller cannot edit or inflate them.', tipMrr:'MRR = Monthly Recurring Revenue: the recurring subscription income per month. The chart shows how this monthly figure changed day by day — not how much was earned on a given day.' });
Object.assign(T.ru.startupPage, { revenueMetrics:'Метрики выручки', insights:'О стартапе', info:'Информация', allTime:'за всё время', estUsers:'Оценка пользователей', revPerVisitor:'Выручка / посетитель', googleImpr:'Показы в Google (30д)', xFollowers:'Подписчиков в 𝕏', verified:'Проверено', mrrVsPrev:'к пред. 30 дн.', flat:'без изменений', cmDailyRev:'Дневная выручка', cmMrr:'MRR', cmCustomers:'Клиенты', cmSubs:'Подписки', cmGrowth:'Рост %', cmVisitors:'Посетители', cmPrice:'Цена', perDaySuffix:'д', perAll:'Всё', legCurrent:'Текущий период', legPrevious:'Предыдущий период', legNow:'Сейчас', legMax:'Макс', legMin:'Мин', legPoints:'точек: {n}', vsPrevPeriod:'к пред. периоду', vsPrevNDays:'к пред. {n} дн.', ttAvgPayment:'Средний платёж: {v}', ttPayments:'{n} платежей', reset:'Сбросить', rankBasis:'по выручке', ttPrev:'Пред.', tipVerified:'Выручка и MRR подтверждены напрямую из платёжного сервиса — продавец не может их изменить или накрутить.', tipMrr:'MRR (Monthly Recurring Revenue) — регулярный доход от подписок за месяц. График показывает, как менялась эта месячная цифра день за днём, а не сколько заработано за день.' });
Object.assign(T.de.startupPage, { revenueMetrics:'Umsatzkennzahlen', insights:'Startup-Einblicke', info:'Info', allTime:'gesamt', estUsers:'Geschätzte Nutzer', revPerVisitor:'Umsatz / Besucher', googleImpr:'Google-Impressionen (30T)', xFollowers:'𝕏-Follower', verified:'Verifiziert', mrrVsPrev:'vs. vorh. 30T', flat:'unverändert', cmDailyRev:'Täglicher Umsatz', cmMrr:'MRR', cmCustomers:'Kunden', cmSubs:'Abonnements', cmGrowth:'Wachstum %', cmVisitors:'Besucher', cmPrice:'Verkaufspreis', perDaySuffix:'T', perAll:'Alle', legCurrent:'Aktueller Zeitraum', legPrevious:'Vorheriger Zeitraum', legNow:'Jetzt', legMax:'Max', legMin:'Min', legPoints:'{n} Punkte', vsPrevPeriod:'vs. vorh. Zeitraum', vsPrevNDays:'vs. vorh. {n}T', ttAvgPayment:'Ø Zahlung: {v}', ttPayments:'{n} Zahlungen', reset:'Zurücksetzen', rankBasis:'nach Umsatz', ttPrev:'Vorh.', tipVerified:'Umsatz und MRR werden direkt vom Zahlungsanbieter bestätigt — der Verkäufer kann sie nicht ändern oder beschönigen.', tipMrr:'MRR (Monthly Recurring Revenue) — wiederkehrende Abo-Einnahmen pro Monat. Das Diagramm zeigt, wie sich dieser Monatswert Tag für Tag verändert hat — nicht die Tageseinnahmen.' });
Object.assign(T.fr.startupPage, { revenueMetrics:'Indicateurs de revenu', insights:'Aperçu de la startup', info:'Infos', allTime:'au total', estUsers:'Utilisateurs estimés', revPerVisitor:'Revenu / visiteur', googleImpr:'Impressions Google (30j)', xFollowers:'Abonnés 𝕏', verified:'Vérifié', mrrVsPrev:'vs 30j préc.', flat:'stable', cmDailyRev:'Revenu quotidien', cmMrr:'MRR', cmCustomers:'Clients', cmSubs:'Abonnements', cmGrowth:'Croissance %', cmVisitors:'Visiteurs', cmPrice:'Prix demandé', perDaySuffix:'j', perAll:'Tout', legCurrent:'Période actuelle', legPrevious:'Période précédente', legNow:'Actuel', legMax:'Max', legMin:'Min', legPoints:'{n} points', vsPrevPeriod:'vs période préc.', vsPrevNDays:'vs {n}j préc.', ttAvgPayment:'Paiement moyen : {v}', ttPayments:'{n} paiements', reset:'Réinitialiser', rankBasis:'par revenu', ttPrev:'Préc.', tipVerified:'Le revenu et le MRR sont confirmés directement par le prestataire de paiement — le vendeur ne peut ni les modifier ni les gonfler.', tipMrr:'MRR (Monthly Recurring Revenue) — revenu d’abonnement récurrent par mois. Le graphique montre comment ce chiffre mensuel a évolué jour après jour, pas les gains d’un jour.' });
Object.assign(T.it.startupPage, { revenueMetrics:'Metriche di fatturato', insights:'Panoramica startup', info:'Info', allTime:'totale', estUsers:'Utenti stimati', revPerVisitor:'Fatturato / visitatore', googleImpr:'Impression Google (30g)', xFollowers:'Follower 𝕏', verified:'Verificato', mrrVsPrev:'vs 30g prec.', flat:'stabile', cmDailyRev:'Fatturato giornaliero', cmMrr:'MRR', cmCustomers:'Clienti', cmSubs:'Abbonamenti', cmGrowth:'Crescita %', cmVisitors:'Visitatori', cmPrice:'Prezzo richiesto', perDaySuffix:'g', perAll:'Tutto', legCurrent:'Periodo attuale', legPrevious:'Periodo precedente', legNow:'Ora', legMax:'Max', legMin:'Min', legPoints:'{n} punti', vsPrevPeriod:'vs periodo prec.', vsPrevNDays:'vs {n}g prec.', ttAvgPayment:'Pagamento medio: {v}', ttPayments:'{n} pagamenti', reset:'Reimposta', rankBasis:'per fatturato', ttPrev:'Prec.', tipVerified:'Ricavi e MRR sono confermati direttamente dal fornitore di pagamenti — il venditore non può modificarli o gonfiarli.', tipMrr:'MRR (Monthly Recurring Revenue) — ricavo ricorrente da abbonamenti al mese. Il grafico mostra come è cambiato questo valore mensile giorno per giorno, non gli incassi del giorno.' });
Object.assign(T.zh.startupPage, { revenueMetrics:'收入指标', insights:'初创公司概览', info:'信息', allTime:'累计', estUsers:'预估用户', revPerVisitor:'每访客收入', googleImpr:'Google 展示次数（30天）', xFollowers:'𝕏 粉丝', verified:'已验证', mrrVsPrev:'对比前30天', flat:'持平', cmDailyRev:'每日收入', cmMrr:'MRR', cmCustomers:'客户', cmSubs:'订阅', cmGrowth:'增长 %', cmVisitors:'访客', cmPrice:'要价', perDaySuffix:'天', perAll:'全部', legCurrent:'当前周期', legPrevious:'上一周期', legNow:'当前', legMax:'最高', legMin:'最低', legPoints:'{n} 个点', vsPrevPeriod:'对比上一周期', vsPrevNDays:'对比前{n}天', ttAvgPayment:'平均付款：{v}', ttPayments:'{n} 笔付款', reset:'重置', rankBasis:'按收入', ttPrev:'上期', tipVerified:'收入和 MRR 直接由支付服务商确认，卖家无法修改或虚报。', tipMrr:'MRR（每月经常性收入）— 每月来自订阅的经常性收入。图表显示这一每月数值如何逐日变化，而非当天收入。' });
Object.assign(T.ar.startupPage, { revenueMetrics:'مقاييس الإيرادات', insights:'نظرة على الشركة', info:'معلومات', allTime:'إجمالاً', estUsers:'المستخدمون المقدّرون', revPerVisitor:'الإيراد / زائر', googleImpr:'ظهور Google (30 يوم)', xFollowers:'متابعو 𝕏', verified:'موثَّق', mrrVsPrev:'مقابل 30 يومًا سابقة', flat:'دون تغيير', cmDailyRev:'الإيراد اليومي', cmMrr:'MRR', cmCustomers:'العملاء', cmSubs:'الاشتراكات', cmGrowth:'النمو %', cmVisitors:'الزوار', cmPrice:'سعر الطلب', perDaySuffix:'ي', perAll:'الكل', legCurrent:'الفترة الحالية', legPrevious:'الفترة السابقة', legNow:'الآن', legMax:'الأقصى', legMin:'الأدنى', legPoints:'{n} نقطة', vsPrevPeriod:'مقابل الفترة السابقة', vsPrevNDays:'مقابل {n} يوم سابقة', ttAvgPayment:'متوسط الدفعة: {v}', ttPayments:'{n} دفعة', reset:'إعادة', rankBasis:'حسب الإيراد', ttPrev:'السابق', tipVerified:'الإيرادات و MRR مؤكدة مباشرة من مزوّد الدفع — لا يمكن للبائع تعديلها أو تضخيمها.', tipMrr:'MRR (الإيراد الشهري المتكرر) — الدخل المتكرر من الاشتراكات شهريًا. يعرض الرسم كيف تغيّر هذا الرقم الشهري يومًا بعد يوم، وليس إيراد ذلك اليوم.' });
...
function buildNavHTML(activePage) {
  ...
  const links = [
    ...
    { href:'/vote',        key:'vote',    active: activePage==='vote' },
  ];
  ...
  <nav>
    ...
    <div class="nav-mobile-quick">
      <a class="nav-mq-link" href="/catalog">${label('catalog')}</a>
      <div id="navAuthMobileTop"></div>
    </div>
...
async function updateNavAuth(session) {
  ...
  // Compact auth button pinned in the mobile header (next to the catalog link and
  // burger) - "register" for guests, account link once signed in.
  const mobileTop = document.getElementById('navAuthMobileTop');
  if (mobileTop) {
    if (!session?.user) {
      const from = encodeURIComponent(location.pathname + location.search);
      mobileTop.innerHTML = `<a class="btn btn-primary btn-sm nav-mq-reg" href="/auth.html?from=${from}">${t('auth','createAccount')}</a>`;
    } else {
      const name = escHtml(session.user.email?.split('@')[0] || 'Account');
      mobileTop.innerHTML = `<a class="btn btn-ghost btn-sm nav-acct" href="/dashboard.html">${name}</a>`;
    }
  }
...
function getPaywallState() {
  // Site / founder / startup name are gated behind a free account. Registered
  // users (free or paid) see everything - no blur, no tooltip. Guests get a
  // prompt to register for free.
  const a = window._access;
  if (a && a.authenticated) return null;
  return {
    kind: 'guest',
    title: t('startupPage', 'regGate'),
    body:  t('startupPage', 'regNote'),
    cta:   t('startupPage', 'regBtn'),
    action: 'signin',
  };
}
