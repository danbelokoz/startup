...
function openSellModal() {
  ...
  const planOptions = [
    ...
    { id:'pro',     price:'$149', features:[S('fListed'),S('fBrand'),S('fNewsletter'),S('f3x')], popular:true },
    { id:'premium', price:'$399', features:[S('fProPerks'),S('f20x'),S('fPinned'),S('fMatching')], popular:false },
  ];
  modal.innerHTML = `
