...
Object.assign(T.en, { gate: { title:'Create a free account to see everything', sub:'Revenue, MRR, seller website and founder — no subscription, no card.', haveAcc:'Already have an account?', noAcc:'No account yet?', freeNote:'Free · no card required', gotIt:'Got it', errFields:'Enter your email and a password.', locked:'This startup is available to registered users', lockedCta:'Register free' } });
Object.assign(T.ru, { gate: { title:'Создайте бесплатный аккаунт, чтобы увидеть всё', sub:'Выручка, MRR, сайт продавца и основатель — без подписки и без карты.', haveAcc:'Уже есть аккаунт?', noAcc:'Ещё нет аккаунта?', freeNote:'Бесплатно · без карты', gotIt:'Понятно', errFields:'Введите email и пароль.', locked:'Этот стартап доступен зарегистрированным пользователям', lockedCta:'Зарегистрироваться бесплатно' } });
Object.assign(T.de, { gate: { title:'Erstelle ein kostenloses Konto, um alles zu sehen', sub:'Umsatz, MRR, Verkäufer-Website und Gründer — ohne Abo, ohne Karte.', haveAcc:'Schon ein Konto?', noAcc:'Noch kein Konto?', freeNote:'Kostenlos · ohne Karte', gotIt:'Verstanden', errFields:'Gib E-Mail und Passwort ein.', locked:'Dieses Startup ist registrierten Nutzern vorbehalten', lockedCta:'Kostenlos registrieren' } });
Object.assign(T.fr, { gate: { title:'Créez un compte gratuit pour tout voir', sub:'Revenus, MRR, site du vendeur et fondateur — sans abonnement ni carte.', haveAcc:'Vous avez déjà un compte ?', noAcc:'Pas encore de compte ?', freeNote:'Gratuit · sans carte', gotIt:'Compris', errFields:'Saisissez votre e-mail et un mot de passe.', locked:'Cette startup est réservée aux utilisateurs inscrits', lockedCta:'S’inscrire gratuitement' } });
Object.assign(T.it, { gate: { title:'Crea un account gratuito per vedere tutto', sub:'Ricavi, MRR, sito del venditore e fondatore — senza abbonamento e senza carta.', haveAcc:'Hai già un account?', noAcc:'Non hai ancora un account?', freeNote:'Gratis · senza carta', gotIt:'Ho capito', errFields:'Inserisci email e password.', locked:'Questa startup è riservata agli utenti registrati', lockedCta:'Registrati gratis' } });
Object.assign(T.zh, { gate: { title:'免费注册账户，查看全部信息', sub:'收入、MRR、卖家网站和创始人 — 无需订阅，无需银行卡。', haveAcc:'已有账户？', noAcc:'还没有账户？', freeNote:'免费 · 无需银行卡', gotIt:'知道了', errFields:'请输入邮箱和密码。', locked:'该初创公司仅向注册用户开放', lockedCta:'免费注册' } });
